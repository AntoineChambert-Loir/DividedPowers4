...
2/ Can one prove that then there is a DP-structure in any ideal generated by a prime number?
For the moment, the proof uses the fact that the ring is a domain.
Maybe, a TODO is enough here. -/
