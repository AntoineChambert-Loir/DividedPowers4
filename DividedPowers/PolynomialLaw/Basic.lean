...
@[ext]
structure PolynomialLaw (R : Type u) [CommRing R]
    (M : Type*) [AddCommGroup M] [Module R M] (N : Type*) [AddCommGroup N] [Module R N] where
...
theorem PolynomialLaw.isCompat_apply'
    {R : Type u} [CommRing R] {M : Type*} [AddCommGroup M] [Module R M]
    {N : Type*} [AddCommGroup N] [Module R N] {f : M →ₚₗ[R] N}
    {S : Type u} [CommRing S] [Algebra R S] {S' : Type u} [CommRing S'] [Algebra R S']
    (φ : S →ₐ[R] S') (x : S ⊗[R] M) :
...
theorem id_apply' {S : Type u} [CommRing S] [Algebra R S] :
...
theorem one_tmul_ground_apply' {S : Type u} [CommRing S] [Algebra R S] (x : M) :
